...
if project_id is None:
    ...
    file_sub_name = os.getenv('file_sub_name', None)
    upload_bucket_name= os.getenv('upload_bucket_name', None)
    download_bucket_name= os.getenv('download_bucket_name', None)
